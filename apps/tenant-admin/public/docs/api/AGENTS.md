...
- THE NAME MUST BE <domain>.<entity>.<verb>.v<N> — lowercase, '-' or '_' inside a segment, at least two segments before the version. All 294 platform types follow it and registration rejects anything that does not.
